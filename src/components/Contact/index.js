const Contact = ({ contactData, checkedIds, onToggleContactFromList, handleDeleteContact }) => {
  ...
  return (
    <tr>
      ...
      <td><i className="fa fa-trash-o" onClick={() => handleDeleteContact(contactData.id)}/></td>
